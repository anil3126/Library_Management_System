     ...
     <main className="relative flex-1 p-6 pt-28">
       ...
       <div className="flex flex-col-reverse xl:flex-row">
        ...
        xl:gap-20 py-5">
         ...
         {/** Right Side */}
         <div className="flex flex-[4] flex-col gap-7 lg:gap-7 lg:py-5 
         ...
         >
          ...
          <div className="hidden xl:flex bg-white p-7 text-lg sm:text-xl xl:text-3xl 
          2xl:text-4xl min-h-52 font-semibold relative flex-[3] justify-center items-center rounded-2xl">
