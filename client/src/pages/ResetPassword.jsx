  ...
  return <>
     <div className="flex flex-col justify-center md:flex-row h-screen">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
               <Link 
               to={"/password/forgot"} className="absolute top-5 left-5 border-2 border-black
              rounded-3xl font-bold py-2 px-6
                  ...
                  <div className="w-full max-w-sm">
                    ...
                    <h1 className="text-4xl font-medium text-center mb-5 overflow-hidden">
                      ...
                      <p className="text-gray-800 text-center mb-12">
                        ...
                        <form onSubmit={hanldeResetPassword}>
                          ...
                          <button
                           type="submit" className="border-2 mt-5
                           border-black w-full font-semibold bg-black
                           text-white py-2 rounded-lg hover:bg-white
                           hover:text-black transition" disabled={loading ? true: false}>RESET PASSWORD
                           </button>
                        </form>
                  </div>
              </div>
