     ...
     <div className="flex flex-col justify-center md:flex-row h-screen">
        {/* LEFT SIDE */}
          <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
           <Link to={"/register"} className="absolute top-5 left-5 border-2 border-black
        ...
        hover:bg-black hover:text-white transition duration-300"
           ...
           <div className="max-w-sm w-full">
             ...
             <form onSubmit={handleOtpVerification}>
              ...
              hover:text-black transition">VERIFY</button>
             </form>
           </div>
          </div>
        {/* RIGHT SIDE */}
          ...
          justify-center p-8 rounded-tl-[80px] rounded-bl-[80px]">
            <div className="text-center h-[400px]">
              ...
              border-white px-8 w-full font-semibold bg-black
              text-white py-2 rounded-lg hover:bg-white
              hover:text-black transition">SIGN UP</Link>
            </div>
          </div>
     </div>
